...
101C:   BEQ  R0,R3,0x108C   // while(i != 128)
    ...
    1028:   BEQ R1,R3,0x1084    // while(j != 128) 
        ...
        1034:   BEQ R2,R3,0x106C    //while(k != 128) 
            ...
            1048:   SLL R23,R0,0x7      // R23 = 128*k                  -- compute address a[k][j]
            104C:   ADD R24,R23,R2      // R24 = R23 + j                -- compute address a[k][j]
            1050:   SLL R24,R24,0x2     // R24 = 4*R24                  -- compute address a[k][j]
            1054:   ADD  R24,R24,R12    // R24 = base_addrA + R24       -- compute address a[k][j]
        ...
        106C:   ADDI R1,R1,0x1      // ++j
        1070:   ADD R20,R21,R1      // R20 = R20 + j            -- compute address c[i][j]
        1074:   SLL R20,R20,0x2     // R20 = 4*R20              -- compute address c[i][j]
        1078:   ADD  R20,R20,R10    // R20 = R20 + base_addrC   -- compute address c[i][j]
        107C:   STW  R4, 0(R20)     // c[i][j] = R4
        1080:   JUMP 0x1028
