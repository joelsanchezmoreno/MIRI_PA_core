...
if __name__== "__main__":
    ...
    for i, l in enumerate(lines1):
        ...
        print(a[row][column], a[row][column+1], a[row][column+2], a[row][column+3])
        column += 4
    ...
    for i, l in enumerate(lines2):
        ...
        print(b[row][column], b[row][column+1], b[row][column+2], b[row][column+3])
        column += 4
    ...
    for i in range(1,n):
        for j in range(1,n,4):
            ...
            print(c[i][j], c[i][j+1], c[i][j+2], c[i][j+3])
